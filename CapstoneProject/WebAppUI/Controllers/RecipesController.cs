...
namespace WebAppUI.Controllers
{
    public class RecipesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Temperature")] Recipe recipe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Temperature")] Recipe recipe)
        {
            if (id != recipe.Id)
            {
                return NotFound();
